  ...
  <div class="position-absolute top-50 start-50 translate-middle card bg-transparent border border-dark" style="width: 20rem">
    ...
    <h1 class="fontRubikBubbles card-header text-center border border-dark">Register</h1>
      <div class="card-body">
        ...
        <label for="confirmPolicy" class="buttonAnnimation">I aggree to your <a href="/privacyPolicy" data-uri="/privacyPolicy" target="_blank" class="link-underline-primary changeCursor buttonAnnimation">privacy policy</a></label>
        </div>
